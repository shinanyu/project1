...
<div class="topMenu" >
	...
	<div class="container" align="center">
		...
		<form action="${path}/update/${noticelist.nb_no}" method="post" name="frm"
			onsubmit="return chk()">
			<table class="table table-striped">
				...
				<tr>
					<td>
					<input type="text" name="nb_title" required="required" style="width: 900px; height: 25px;"
						value="${noticelist.nb_title}">
					</td>
				</tr>
				<tr>
					<td>내용</td>
				...
				<tr>
					<td>
						<textarea name="nb_content" required="required" style="width: 900px; height: 450px;">
						${noticelist.nb_content}</textarea>
						</td>
				</tr>
				<tr>
